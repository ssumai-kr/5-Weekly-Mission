...
function FolderList() {
  ...
  const [modalAbout, setModalAbout] = useState(""); //모달 about
    ...
    <>
      <div className={styles.folderLists}>
        <div className={styles.folderList__Container}>
          ...
          <button className={styles.folderList__plus} onClick={() => (openModal("폴더 추가"))}>
      ...
      {showModal && (<EtcModal about={modalAbout} onClick={closeModal}></EtcModal>)}
    </>
  );
}
